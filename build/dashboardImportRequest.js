...
exports.dashboardImportRequestSchema = {
    ...
    "description": "dashboardImportRequest schema",
    "type": "object",
    "allOf": [
        {
...
let dashboardImportRequestAjv = null;
function dashboardImportRequestValidator() {
    if (dashboardImportRequestAjv == null) {
        dashboardImportRequestAjv = new Ajv({ validateSchema: false }).compile(exports.dashboardImportRequestSchema);
    }
    return dashboardImportRequestAjv;
}
exports.dashboardImportRequestValidator = dashboardImportRequestValidator;
