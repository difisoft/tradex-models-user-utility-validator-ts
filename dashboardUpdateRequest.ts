...
export const dashboardUpdateRequestSchema = {
...
export function dashboardUpdateRequestValidator() {
  if (dashboardUpdateRequestAjv == null) {
    dashboardUpdateRequestAjv = new Ajv({validateSchema: false}).compile(dashboardUpdateRequestSchema);
  }
