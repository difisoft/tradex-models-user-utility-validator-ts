...
export const dashboardImportRequestSchema = {
...
export function dashboardImportRequestValidator() {
  if (dashboardImportRequestAjv == null) {
    dashboardImportRequestAjv = new Ajv({validateSchema: false}).compile(dashboardImportRequestSchema);
  }
