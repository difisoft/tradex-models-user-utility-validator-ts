...
export const favoriteListUpdateRequestSchema = {
...
export function favoriteListUpdateRequestValidator() {
  if (favoriteListUpdateRequestAjv == null) {
    favoriteListUpdateRequestAjv = new Ajv({validateSchema: false}).compile(favoriteListUpdateRequestSchema);
  }
