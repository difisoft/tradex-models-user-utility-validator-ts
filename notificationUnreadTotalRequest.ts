...
export const notificationUnreadTotalRequestSchema = {
...
export function notificationUnreadTotalRequestValidator() {
  if (notificationUnreadTotalRequestAjv == null) {
    notificationUnreadTotalRequestAjv = new Ajv({validateSchema: false}).compile(notificationUnreadTotalRequestSchema);
  }
