...
export const notificationMarkRequestSchema = {
...
export function notificationMarkRequestValidator() {
  if (notificationMarkRequestAjv == null) {
    notificationMarkRequestAjv = new Ajv({validateSchema: false}).compile(notificationMarkRequestSchema);
  }
