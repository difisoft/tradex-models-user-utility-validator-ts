...
export const alarmUpdateResponseSchema = {
...
export function alarmUpdateResponseValidator() {
  if (alarmUpdateResponseAjv == null) {
    alarmUpdateResponseAjv = new Ajv({validateSchema: false}).compile(alarmUpdateResponseSchema);
  }
