...
export const alarmAddRequestSchema = {
...
export function alarmAddRequestValidator() {
  if (alarmAddRequestAjv == null) {
    alarmAddRequestAjv = new Ajv({validateSchema: false}).compile(alarmAddRequestSchema);
  }
