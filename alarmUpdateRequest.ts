...
export const alarmUpdateRequestSchema = {
...
export function alarmUpdateRequestValidator() {
  if (alarmUpdateRequestAjv == null) {
    alarmUpdateRequestAjv = new Ajv({validateSchema: false}).compile(alarmUpdateRequestSchema);
  }
